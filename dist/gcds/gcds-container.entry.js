...
const GcdsContainer = class {
    ...
    render() {
        ...
        const Tag = tag;
        return (h(Host, { size: size }, h(Tag, { class: `
            gcds-container
...
export { GcdsContainer as gcds_container };

//# sourceMappingURL=gcds-container.entry.js.map